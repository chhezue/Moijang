...
export class UserRepository {
  ...
  async findOneByUniversityEmail(universityEmail: string): Promise<UserWithUniversity | null> {
    return (await this.usersModel
  ...
  async createOne(user: CreateUserDto, hashPassword: string): Promise<UserWithUniversity> {
